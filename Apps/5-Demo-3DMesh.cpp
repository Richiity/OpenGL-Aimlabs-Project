...
Mesh cube;
const char *meshFile = "C:\\Users\\deant\\Code\\Graphics\\Assets\\Models\\Pistol.obj";
const char *textureFile = "C:\\Users\\deant\\Code\\Graphics\\Assets\\Images\\Pistol_gloss.jpg";
...
int main(int ac, char **av) {
	...
	cube.Read(string(meshFile), string(textureFile));
	// callbacks
